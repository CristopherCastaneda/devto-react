...
const SocialButtons = () => {
  return (
      <div className="w-100">
          <Button type="button" variant="social"><svg xmlns="http://www.w3.org/2000/svg" width="24" heigth="24" class="crayons-icon" viewBox="0 0 24 24" role="img" aria-labelledby="a5os4651864yb9riwrov0r0w78yv46pe" aria-hidden="true">
              <title>apple</title>
