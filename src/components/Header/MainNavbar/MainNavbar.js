...
const MainNavbar = ({handleShow, handleShowSearch, showSearch}) => {
      ...
      <Container className="d-flex justify-content-between align-items-center">
        <div className='logo d-flex align-items-center'>
            <Button variant="hamburger" onClick={handleShow} className="d-inline-block d-md-none">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aonl8imamdoklwc0tz1ajg2ds3dybvot" class="crayons-icon">
        ...
        <div className='user d-flex align-items-center gap-3'>
            ...
            <Link to="/login" className={`btn ${styles.btnLogin} d-none d-md-block`}>Log in</Link>
            <Link to="/" className={`${styles.btnCreateAccount} d-none d-md-block`} >Create Account</Link>
        </div>        
      </Container>
    </Navbar>
  )
