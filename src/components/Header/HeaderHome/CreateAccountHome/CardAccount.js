const CardAccount = () => {
    return (
        <div className="block-login col-12 col-md-11 col-lg-8">
            <section className="crayons-layout">
                <div className="registration crayons-card">
                    <div className="registration_content">
                        <h1 className="registration_title">Welcome to DEV Community 👩‍💻👨‍💻
                        </h1>
                        <p className="registration_description">
                            <a href="/index.html" className="c-link c-link--branded">DEV Community 👩‍💻👨‍💻 </a> is a community of 900,148 amazing developers
                        </p>
                    </div>
                    <div className="registration_actions">
                        <div className="registration_actions_cards">
                            <form className="flex w-100" action="">
                                <input type="hidden" name="" id=""/>
                                    <button name="button" type="submit" className="crayons-btn crayons-btn--l crayons-btn--brand-apple crayons-btn--icon-left grow-1 whitespace-nowrap">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" heigth="24" className="crayons-icon" viewBox="0 0 24 24" role="img" aria-labelledby="a5os4651864yb9riwrov0r0w78yv46pe" aria-hidden="true">
                                            <title>apple</title>
                            ...
                            <form className="flex w-100" action="">
                                <input type="hidden" name="" id=""/>
                                    <button name="button" type="submit" className="crayons-btn crayons-btn--l crayons-btn--brand-forem crayons-btn--icon-left grow-1 whitespace-nowrap">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="24" heigth="24" className="crayons-icon" viewBox="0 0 200.000000 200.000000" preserveAspectRatio="xMidYMid meet" role="img" aria-labelledby="af0v1ak0xrhp5l7065o2cda8ctkluve2" aria-hidden="true">
                                            <title>Forem</title>
                            ...
                            <form className="flex w-100" action="">
                                <input type="hidden" name="" id=""/>
                                    <button name="button" type="submit" className="crayons-btn crayons-btn--l crayons-btn--brand-github crayons-btn--icon-left grow-1 whitespace-nowrap">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="crayons-icon" viewbox="0 0 24 24" role="img" aria-labelledby="ah40b3uyrystfab1ribq9hrn8ulcuia5" aria-hidden="true">
                                            <title>Github</title>
                            ...
                            <form className="flex w-100" action="">
                                <input type="hidden" name="" id=""/>
                                    <button name="button" type="submit" className="crayons-btn crayons-btn--l crayons-btn--brand-twitter crayons-btn--icon-left grow-1 whitespace-nowrap" >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="crayons-icon" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a88a7506l5k7ni6r533vhhb6ovefr5da" aria-hidden="true" >
                                            <title>twitter</title>
                        ...
                        <div className="registration__actions-email">
                            <div className="registration_hr">
                                <span className="registration_hr-label">
