...
function ShowMorePopUp({display}) {
  ...
  return (
    <div className={`p-3 m-1 ${displayClass} ${styles.showMoreDropdown}`}>
                <div>
                    <button id="copy-url-button" className="d-flex justify-content-between border-0 bg-transparent p-0 mb-2" data-posturl="http://127.0.0.1:5500/detail.html?id=630e36f085e662581110e452">
